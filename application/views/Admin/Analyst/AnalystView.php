                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                <ul class="nav nav-pills nav-pills-sm nav-light">
                                    <li class="nav-item">
                                        <a href="<?= site_url('admin/analyst/'.$detail['id_project'].'/addanalyst'); ?>" class="btn btn-success">Add Analyst</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <?php if (!empty($analyst)) : $i = 1; foreach ($analyst as $value) : ?>
                                    <tr>
                                        ...
                                        <ul style="list-style-type:none;padding-left:0px">
                                            ...
                                            <br/>
                                            <li>
                                            <a href="<?= site_url('admin/deleteanalyst/'.$detail['id_project'].'/'.$value->id_analyst.''); ?>" class="badge badge-light-danger btn-sm mb-0">
