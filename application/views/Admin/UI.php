								...
								<div class="hover-scroll-y pe-4 pe-lg-5" id="kt_aside_menu_scroll" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo" data-kt-scroll-wrappers="#kt_aside_wordspace" data-kt-scroll-offset="10px">
									<div class="menu-wrapper menu-column menu-fit">
										...
										<li class="menu-item py-1">
                                                <a class="menu-link px-3 <?= ($navlink === 'dashboard') ? 'active' : ''; ?>" href="<?= site_url('admin/index'); ?>" >
                                             ...
                                             <li class="menu-item py-1">
                                                <a class="menu-link px-3 <?= ($navlink === 'client') ? 'active' : ''; ?>" href="<?= site_url('admin/client'); ?>">
                                                    <span class="menu-icon">
                                            ...
                                            <li class="menu-item py-1">
                                                <a class="menu-link px-3 <?= ($navlink === 'project') ? 'active' : ''; ?>" href="<?= site_url('admin/project'); ?>">
                                                    <span class="menu-icon">
                                            ...
                                            <li class="menu-item py-1">
												<a class="menu-link px-3 <?= ($navlink === 'analyst') ? 'active' : ''; ?>" href="<?= site_url('admin/analyst'); ?>">
                                                    <span class="menu-icon">
                                                        <i class="bi bi-person-plus"></i>
                                                    </span>
										...
										<li class="menu-item py-1">
										<a class="menu-link px-3 <?= ($navlink === 'staff') ? 'active' : ''; ?>" href="<?= site_url('admin/staff'); ?>">
                                                    <span class="menu-icon">
                                            ...
                                            <li class="menu-item py-1">
											<a class="menu-link px-3 <?= ($navlink === 'team') ? 'active' : ''; ?>" href="<?= site_url('admin/team'); ?>">
                                        ...
                                        <ul class="menu menu-custom menu-column menu-rounded menu-title-gray-600 menu-icon-muted menu-hover-bg-light-primary menu-active-bg-light-primary fw-bold">
                                            ...
                                            <li class="menu-item py-1">
												<a class="menu-link px-3 <?= ($navlink === 'schedule') ? 'active' : ''; ?>" href="<?= site_url('admin/schedule'); ?>">
                                                    <span class="menu-icon">
                                                    <i class="bi bi-window"></i>
                                                    </span>
                                            ...
                                            <li class="menu-item py-1">
												<a class="menu-link px-3 <?= ($navlink === 'task') ? 'active' : ''; ?>" href="<?= site_url('admin/task'); ?>">
                                                    <span class="menu-icon text-xl">
                                                        <!--begin::Svg Icon | path: icons/duotone/Communication/Mail-heart.svg-->
                                                        <i class="bi bi-person-plus"></i>
                                                        <!--end::Svg Icon-->
                                            ...
                                            <li class="menu-item py-1">
											<a class="menu-link px-3 <?= ($navlink === 'review') ? 'active' : ''; ?>" href="<?= site_url('admin/review'); ?>">
                                                    <span class="menu-icon text-xl">
                                                        <!--begin::Svg Icon | path: icons/duotone/Communication/Mail-heart.svg-->
                                                        <i class="bi bi-grid"></i>
                                                        <!--end::Svg Icon-->
                                        ...
                                        <ul class="menu menu-custom menu-column menu-rounded menu-title-gray-600 menu-icon-muted menu-hover-bg-light-primary menu-active-bg-light-primary fw-bold">
                                            ...
                                            <li class="menu-item py-1">
											<a class="menu-link px-3 <?= ($navlink === 'progress') ? 'active' : ''; ?>" href="<?= site_url('admin/progress'); ?>">
                                                    <span class="menu-icon">
                                                    <i class="bi bi-window"></i>
                                                    </span>
                                            ...
                                            <li class="menu-item py-1">
											<a class="menu-link px-3 <?= ($navlink === 'report') ? 'active' : ''; ?>" href="<?= site_url('admin/report'); ?>">
                                                    <span class="menu-icon text-xl">
                                                        <!--begin::Svg Icon | path: icons/duotone/Communication/Mail-heart.svg-->
                                                        <i class="bi bi-person-plus"></i>
                                                        <!--end::Svg Icon-->
                                    ...
                                    <div class="ms-1 ms-lg-6">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold w-200px" data-kt-menu="true">
                                            ...
                                            <div class="row row-cols g-0">
                                                <a href="<?= site_url('admin/logout'); ?>" class="col text-center py-10 btn btn-active-color-primary rounded-0">
