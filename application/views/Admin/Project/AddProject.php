                    ...
                    <div class="pb-10">
                        <div class="py-5">
                            <div class="rounded border-dashed p-10">
                                ...
                                <form action="<?= site_url('admin/addproject'); ?>" method="post">
                                ...
                                <div class="d-flex">
                                        <div class="col-sm-6 px-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <select name="id_client" id="cleint" class="form-select form-select-solid bg-white" data-control="select2" data-placeholder="Select an option" required>
                                                        <option disabled selected>Select</option>
                                                    <?php if (!empty($client)) : $i = 1; foreach ($client as $value) : ?>
                                                        <option value="<?= $value->id_client; ?>"><?= $value->client_name; ?></option> 
                                        ...
                                        <div class="col-sm-6 px-5">
                                            <div class="mb-10">
                                                ...
                                                <input type="date" name="start_date" class="form-control" placeholder="Pick a date" id="kt_datepicker_1" required/>
                                            </div>
                                            <div class="mb-10">
                                                <label for="" class="form-label">End Date</label>
                                                <input type="date" name="end_date" class="form-control" placeholder="Pick a date" id="kt_datepicker_2" required/>
                                            </div>
                                            <div class="mb-10">
