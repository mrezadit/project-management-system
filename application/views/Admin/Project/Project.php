            ...
            <div class="card-body p-5 p-lg-10 pb-0">
                ...
                <div class="d-flex flex-stack flex-wrap flex-sm-nowrap">
                    <h1 class="anchor fw-bolder">
                        <a href="<?= site_url('admin/Project'); ?>"></a>Projects&nbsp
                        <span class="text-muted mt-2 fw-bold fs-6"> - Create and update data</span>
                    </h1>
                    
                    <div class="d-flex align-items-center flex-nowrap text-nowrap overflow-auto py-1">
                        <a href="<?= site_url('admin/project/service'); ?>" class="btn btn-light-success mx-5"><i class="bi bi-back text-xl"></i>Services</a>
                        <a href="<?= site_url('admin/project/addproject'); ?>" class="btn btn-success"><i class="bi bi-plus-lg"></i>Project</a>
                    </div>
                </div>
                <!--end::Heading-->
                <hr/>
                        ...
                        <?php if (!empty($project)) : $i = 1; foreach (array_reverse($project) as $value) : ?>
                            <tr>
                                ...
                                <?php if ( $value->p_status == 4) : ?>
                                    ...
                                    completed </span>
                                <?php else : ?>
                                <a href="<?= site_url('admin/project/'.$value->id_project.'/view'); ?>" rel="tooltip" title="Detail" class="badge badge-success">
