                    ...
                    <div class="card card-stretch mb-5 mb-xxl-8">
                        ...
                        <div class="card-header border-0 pt-5">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bolder text-dark fs-3">Progress Details</span>
                            </h3>
                            <div class="card-toolbar">
                            <?php if ($detail['cot'] == 0) :?>
                                <ul class="nav nav-pills nav-pills-sm nav-light">
                                    <li class="nav-item">
                                        <a href="<?= site_url('admin/finishproject/'.$detail['id_project'].''); ?>" class="btn btn-success">Finish Project</a>
                                    </li>
                                </ul>
                                <?php else : ?>
                        ...
                        <div class="d-flex px-10 mb-5">
                            ...
                            <div class="col-sm px-5">
                                ...
                                <div class="mb-3">
                                    <span class="card-label fs-2 mb-5"> <b><?= $detail['persen']?>%</b></span>
                                </div>
                                <div class="mb-3">
