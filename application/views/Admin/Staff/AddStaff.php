                            ...
                            <div class="rounded border-dashed p-10">
                                <div class="d-flex flex-stack flex-wrap flex-sm-nowrap">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="fw-bolder text-dark fs-3 me-2">Create Staff Data</span>
                                        <span class="text-muted mt-2 fw-bold fs-6"> - Form to create a new data</span>
                                    </h3>
                                <form action="<?= site_url('admin/addstaff'); ?>" method="post">
                                    <div class="d-flex align-items-center flex-nowrap text-nowrap overflow-auto py-1">
                                        <a href="<?= site_url('admin/staff/staff'); ?>" class="btn btn-light mx-5">Back</a>
                                ...
                                <div class="d-flex">
                                        <div class="col-sm-6 px-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <select name="id_team" id="client" class="form-select form-select-solid bg-white" data-control="select2" data-placeholder="Select an option" required>
