            ...
            <div class="card-body p-5 p-lg-10 pb-0">
                ...
                <div class="d-flex flex-stack flex-wrap flex-sm-nowrap">
                    <h1 class="anchor fw-bolder">
                        <a href="<?= site_url('analyst/client'); ?>"></a>Report &nbsp
                        ...
                        <?php if (!empty($project)) : $i = 1; foreach (array_reverse($project) as $value) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <li>Date Finished : <br><?= date('d-m-Y',strtotime ($value->ptime)); ?></li>
                                    </ul>
                                </td>
                                <td>
                                <ul style="list-style-type:none;padding-left:0px">
                                ...
                                <td>
                                <a href="<?= site_url('analyst/report/'.$value->id_project.'/view'); ?>" rel="tooltip" title="Detail" class="badge badge-success">
                                    <i class="bi bi-arrow-up-right text-white"></i>Print Out</a>
                                </td>        
