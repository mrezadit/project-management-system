                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="card-toolbar">
                                <ul class="nav nav-pills nav-pills-sm nav-light">
                                    <li class="nav-item">
                                        <a href="<?= site_url('analyst/schedule/addschedule/'.$detail['id_project'].''); ?>" class="btn btn-light-success">Add Schedule</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <table id="datatable" class="table table-row-bordered gy-5">
                                ...
                                <?php if (!empty($schedule)) : $i = 1; foreach ($schedule as $value) : ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a href="<?= site_url('analyst/deleteschedule/'.$detail['id_project'].'/'.$value->id_schedule.'/'.$value->id_task.''); ?>" class="badge badge-light-danger btn-sm mb-0">
