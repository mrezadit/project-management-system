                    ...
                    <div class="pb-10">
                        <div class="py-5">
                            <div class="rounded border p-10">
                                ...
                                <form action="<?= site_url('staff/addtask'); ?>" method="post">
                                    <div class="d-flex align-items-center flex-nowrap text-nowrap overflow-auto py-1">
                                        <a href="<?= site_url('staff/task/task'); ?>" class="btn btn-light mx-5">Back</a>
...
$(document).ready(function(){ // Ketika halaman sudah siap (sudah selesai di load)
    ...
    $("#campaign").change(function(){ // Ketika user mengganti atau memilih data provinsi
        ...
        $.ajax({
            ...
            url: "<?php echo base_url("index.php/staff/listStaff"); ?>", // Isi dengan url/path file php yang dituju
